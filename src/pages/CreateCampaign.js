  ...
  return (
    <div className="max-w-2xl mx-auto bg-[#202d33] p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleCreateCampaign} className="flex flex-col gap-4">
        ...
        <div>
            <label htmlFor="contactList" className={labelStyle}>Send To (Contact List)</label>
        ...
        <input type="text" placeholder="Header Image URL (Optional)" value={headerImageUrl} onChange={(e) => setHeaderImageUrl(e.target.value)} className={inputStyle} />
        <input type="number" placeholder="Number of Body Variables" value={expectedVariables} onChange={(e) => setExpectedVariables(e.target.value)} className={inputStyle} min="0" required />
        <input type="text" placeholder="Google Sheet ID for Live Leads (Optional)" value={spreadsheetId} onChange={(e) => setSpreadsheetId(e.target.value)} className={inputStyle} />
